...
const Sidebar = React.forwardRef((props, ref) => {
  ...
  const iconDetails = {
    ...
    malshabSchedule: { urlPostfix: configApp.sitesPostfixes.nodeGroupSelection, urlPostfixOptions: [configApp.sitesPostfixes.nodeGroupSelection, configApp.sitesPostfixes.malshabSchedule], imgDef: malshabScheduleIcon, imgActive: malshabScheduleIconActive, title: t('sideBar.malshabSchedule') },
  ...
  const createIcon = (iconDetailsObject) => {
    ...
    || iconDetailsObject.urlPostfixOptions?.includes(window.location.pathname)
